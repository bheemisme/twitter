...
public class DeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (email == null) {
            ...
            request.setAttribute("title", "Delete Account");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (email == null) {
            ...
            try {
                ...
                if(!u.getPassword().equals( PasswordHashing.hashPassword(password))){
                    response.sendRedirect("/twitter/delete");
                    return;
                }
                
                if(!User.deleteUser(email, request.getServletContext().getRealPath("static/images"))){
                    response.sendRedirect("/twitter/delete");
                    return;
                }
